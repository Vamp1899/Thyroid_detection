...
class Model_Finder:
    ...
    def get_best_params_for_random_forest(self,train_x,train_y):
        ...
        try:
            ...
            self.param_grid = {"n_estimators": np.arange(10, 150, 50), "criterion": ['gini', 'entropy'],
                               "max_depth": range(2, 4, 1), "max_features": ['auto', 'log2']}

            #Creating an object of the Grid Search class
            self.grid = RandomizedSearchCV(estimator=self.clf, param_grid=self.param_grid, cv=10,  verbose=3)
